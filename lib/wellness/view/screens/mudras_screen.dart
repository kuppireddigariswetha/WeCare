...
List<Mudras> mudrasList() {
  ...
  list.add(Mudras(img: 'assets/yoga/mudras/prana.jpeg', title: 'Prana Mudra', description: 'This mudra is considered one of the primary mudras because it can awaken drowsy energy in the body. The thumb symbolizes fire and divine nature, the ring finger represents earth and physical health, and the little finger signifies water and intuition. '));
